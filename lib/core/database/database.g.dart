    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Date` (`id` INTEGER NOT NULL, `shortName` TEXT NOT NULL, `fullDescription` TEXT NOT NULL, `category` INTEGER NOT NULL, `suit` INTEGER NOT NULL, `favorite` INTEGER NOT NULL, PRIMARY KEY (`id`))');
...
class _$DateDao extends DateDao {
  _$DateDao(
    ...
    this.changeListener,
        ...
        _dateInsertionAdapter = InsertionAdapter(
            database,
            'Date',
            (Date item) => <String, Object?>{
                  'id': item.id,
                  'shortName': item.shortName,
                  'fullDescription': item.fullDescription,
                  'category': item.category.index,
                  'suit': item.suit.index,
  ...
  @override
  Future<List<Date>> findAllDates() async {
  ...
  @override
  Future<void> insertDate(Date data) async {
    await _dateInsertionAdapter.insert(data, OnConflictStrategy.abort);
  }
}
